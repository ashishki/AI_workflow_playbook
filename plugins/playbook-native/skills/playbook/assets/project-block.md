...
- After code changes run the bundled independent Role Runner, fix confirmed findings
  and recheck. Review workers never start another review. Preserve failed review logs.
