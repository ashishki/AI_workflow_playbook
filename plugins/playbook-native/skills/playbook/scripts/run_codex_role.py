...
def build_parser() -> argparse.ArgumentParser:
    ...
    run_parser.add_argument('--profile', choices=('governed', 'native'), default='governed')
    run_parser.add_argument('--request', type=Path, help='Native review brief, inside the project')
    ...
    run_parser.add_argument(
        "--reasoning-effort",
        default=None,
        help="Reasoning effort; governed defaults to medium, native inherits host configuration",
    )
    ...
    try:
        if args.command == "run":
            result, result_path = execute_role_run(
                ...
                model=args.model,
                reasoning_effort=args.reasoning_effort or ('inherit' if args.profile == 'native' else 'medium'),
