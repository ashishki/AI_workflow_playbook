...
# Extracts IMPLEMENTATION_RESULT from legacy external codex exec invocations.
#
...
# For legacy external codex exec/run: extract IMPLEMENTATION_RESULT line from stdout
